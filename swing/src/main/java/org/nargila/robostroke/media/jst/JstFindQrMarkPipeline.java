...
public class JstFindQrMarkPipeline extends Pipeline implements FindQrMarkPipeline, PadListener {
	...
	public JstFindQrMarkPipeline(File ogg) {
	...
	public static void main(String[] args) throws Exception {
		...
		JstFindQrMarkPipeline qrFind = new JstFindQrMarkPipeline(new File(args[0]));
